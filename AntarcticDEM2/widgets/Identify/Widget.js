                            ...
                            } else if (this.map.getLayer("primaryLayer"))
                            {
                                ...
                                var request3 = esriRequest({
                                    ...
                                    content: {
                                        ...
                                        // returnCatalogItems: true,
                                        returnFirstValueOnly: true,
                                        outFields: 'acquisitiondate1,GroupName,Category,LowPS,Source,dx,dy,dz,fileurl,catalogid1,catalogid2',
                                        mosaicRule: this.mosaic,
                                        f: "json"
                                    },
                                    handleAs: "json",
                                ...
                                request3.then(lang.hitch(this, function (metaData) {
                                    ...
                                    this.groupName = props.GroupName;
                                    var href1 = "https://api.discover.digitalglobe.com/show?id=" + (props.catalogid1);
                                    var href2 = "https://api.discover.digitalglobe.com/show?id=" + (props.catalogid2);
                                    this.sourceUrl = props.fileurl;
                                    html.set(this.identifytab, "<table style='border: 0px;'><tr><td>Current Scene ID: " + props.GroupName.substr(0, 21) + (props.acquisitiondate1 !== null ? ("&nbsp;&nbsp;Date: " + locale.format(new Date(props.acquisitiondate1), {selector: "date", formatLength: "long"})) : "") + "</td></tr><tr><td>Source: " + props.Source + "&nbsp;&nbsp;&nbsp;&nbsp;PixelSize: " + props.LowPS + "m&nbsp;&nbsp;&nbsp;Aspect: " + parseInt(data.processedValues[2]) + " deg" + "&nbsp;&nbsp;&nbsp;&nbsp;Slope: " + parseInt(data.processedValues[1]) + " deg" + "</td></tr><tr><td>Correction shifts applied xyz: &nbsp;" + props.dx + ", " + props.dy + ", " + props.dz + " &nbsp;m</td></tr><tr><td>Orthometric height: " + (parseFloat(heightValue)).toFixed(2) + "m" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ellipsoidal height: " + (parseFloat(data.processedValues[3])).toFixed(2) + "m" + "</td></tr><tr><td>Digital Globe Links: <a target='_blank' href=" + href1 + ">Link1</a>   <a target='_blank' href=" + href2 + ">Link2</a>&nbsp;&nbsp;&nbsp;<a id='downloadLink' href='javascript:;'><button>Download DEM</button></a></td></tr></table>");
