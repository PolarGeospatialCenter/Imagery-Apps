                                ...
                                queryTask2.execute(query2, lang.hitch(this, function (queryResult2) {
                                    ...
                                    var request5 = esriRequest({
                                        ...
                                        content: {
                                            ...
                                            outFields: 'acquisitiondate1,OBJECTID,GroupName,Category,ProductName,WRS_Path,WRS_Row,SunAzimuth,SunElevation,CloudCover,LowPS',
                                    ...
                                    request5.then(lang.hitch(this, function (data) {
                                        ...
                                        html.set(this.identifytab, "<table style='border: 0px;'><tr><td>Current Scene ID: " + props.GroupName.substr(0, 21) + "</td><td>&nbsp;&nbsp;Product Name: " + props.ProductName + "</td></tr><tr><td>Acquisition Date: " + locale.format(new Date(props.acquisitiondate1), {selector: "date", formatLength: "long"}) + "</td><td>&nbsp;&nbsp;WRS Path/Row: " + props.WRS_Path + "/" + props.WRS_Row + "</td></tr><tr><td>Sun Azimuth: " + props.SunAzimuth.toFixed(1) + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sun Elevation: " + props.SunElevation.toFixed(1) + "</td><td>&nbsp;&nbsp;Cloud Cover: " + (props.CloudCover * 100).toFixed(1) + "%</td></tr></table>");
                            ...
                            } else if (this.map.getLayer("primaryLayer"))
                            {
                                ...
                                var request3 = esriRequest({
                                    ...
                                    content: {
                                        ...
                                        // returnCatalogItems: true,
                                        returnFirstValueOnly: true,
                                        outFields: 'acquisitiondate1,GroupName,Category,LowPS,Source,dx,dy,dz,fileurl',
                                        mosaicRule: this.mosaic,
                                        f: "json"
                                    },
                                    handleAs: "json",
                                ...
                                request3.then(lang.hitch(this, function (metaData) {
                                    ...
                                    this.groupName = props.GroupName;
                                    // var href1 = "https://api.discover.digitalglobe.com/show?id=" + (props.GroupName).substr(14, 16);
                                    // var href2 = "https://api.discover.digitalglobe.com/show?id=" + (props.GroupName).substr(31, 16);
                                    this.sourceUrl = props.fileurl;
                                    html.set(this.identifytab, "<table style='border: 0px;'><tr><td>Current Scene ID: " + props.GroupName.substr(0, 21) + "&nbsp;&nbsp;Date: " + locale.format(new Date(props.acquisitiondate1), {selector: "date", formatLength: "long"}) + "</td></tr><tr><td>Source: " + props.Source + "&nbsp;&nbsp;&nbsp;&nbsp;PixelSize: " + props.LowPS + "m&nbsp;&nbsp;&nbsp;Aspect: " + parseInt(data.processedValues[2]) + " deg" + "&nbsp;&nbsp;&nbsp;&nbsp;Slope: " + parseInt(data.processedValues[1]) + " deg" + "</td></tr><tr></tr><tr><td>Orthometric height: " + (parseFloat(heightValue)).toFixed(2) + "m" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ellipsoidal height: " + (parseFloat(data.processedValues[3])).toFixed(2) + "m" + "</td></tr><tr><td>&nbsp;&nbsp;&nbsp;<a id='downloadLink' href='javascript:;'><button>Download DEM</button></a></td></tr></table>");
